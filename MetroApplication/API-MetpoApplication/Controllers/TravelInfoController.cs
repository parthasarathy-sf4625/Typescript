...
namespace MetroCardAPI.Controllers
{
    ...
    {
        private static List<TravelInfo> _Travels=new List<TravelInfo>
        {
            new TravelInfo{TravelID=2001,CardID=1001,FromLocation="Airport",ToLocation="Egmore",TravelDate=new DateTime(2023,10,10),TravelCost=55},
            new TravelInfo{TravelID=2002,CardID=1002,FromLocation="Alandur",ToLocation="Koyambedu",TravelDate=new DateTime(2023,11,10),TravelCost=25}
        };
        [HttpGet]
